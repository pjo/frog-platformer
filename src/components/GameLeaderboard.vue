...
<template>
  <section class="bottom-grid">
    ...
    <div class="card panel scoreboard-panel">
      <h2>
        <svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16" class="panel-icon">
          <path
    ...
    <div class="card panel notes-panel">
      <h2>
        <svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16" class="panel-icon">
          <path
            d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm1 3h10v1H5V6zm0 3h10v1H5V9zm0 3h6v1H5v-1z"
          />
        </svg>
        How to Play
      </h2>
      <dl class="notes-list">
        ...
        <div class="note-item">
          <dt>🌍</dt>
          <dd>
            10 worlds: Swamp, Cave, Sky, Lava, Fortress, Ice, Desert, Jungle, Underwater, Void.
          </dd>
        </div>
        <div class="note-item">
          <dt>👑</dt>
    ...
    <div class="card panel a11y-panel">
      <h2>
        <svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16" class="panel-icon">
          <path
            d="M10 2a1.5 1.5 0 100 3 1.5 1.5 0 000-3zM10 6c-1.3 0-4 .5-4 .5L5 8.5l1.5.5L7 12l1.5 5h1L10 12l.5 5h1L13 12l.5-3 1.5-.5-1-2S11.3 6 10 6z"
          />
        </svg>
        Accessibility
      </h2>
...
@media (max-width: 720px) {
  ...
  .leader-row {
    grid-template-columns: 28px 1fr 0.8fr 0.55fr 0.65fr;
    font-size: 0.82rem;
  }
}
</style>

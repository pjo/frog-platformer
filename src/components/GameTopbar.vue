...
<template>
  <header class="topbar card">
    ...
    <div class="center-strip">
      ...
      <span
        class="online-dot"
        :class="isOnline ? 'live' : 'local'"
        :title="isOnline ? 'Live scores' : 'Offline'"
      >
        <span class="dot"></span>
    ...
    <nav class="actions">
      ...
      >
        <svg v-if="!paused" viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
      ...
      <button class="icon-btn" @click="$emit('restart')" title="Restart" aria-label="Restart">
        <svg viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
          <path d="M4 10a6 6 0 0110.61-3.85L12 9h6V3l-2.35 2.35A8 8 0 102 10h2z" />
        </svg>
      </button>
      <button
        class="icon-btn"
      ...
      >
        <svg v-if="!muted" viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
          <path
            d="M10 3a1 1 0 00-1.6-.8L4.27 5.5H2a1 1 0 00-1 1v7a1 1 0 001 1h2.27l4.13 3.3A1 1 0 0010 17V3z"
          />
          <path
            d="M13.5 7.1a4.5 4.5 0 010 5.8M15.4 5.2a7 7 0 010 9.6"
            fill="none"
            stroke="currentColor"
            stroke-width="1.5"
      ...
      >
        <svg v-if="!isFullscreen" viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
          <path
            d="M3 3h5v2H5v3H3V3zM12 3h5v5h-2V5h-3V3zM3 12h2v3h3v2H3v-5zM15 15h-3v2h5v-5h-2v3z"
          />
        </svg>
        <svg v-else viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
          <path d="M8 3v5H3V6h3V3h2zM17 8h-5V3h2v3h3v2zM8 17H3v-5h2v3h3v2zM12 17v-5h5v2h-3v3h-2z" />
        </svg>
      </button>
    </nav>
  </header>

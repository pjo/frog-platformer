...
export function useAudio(muted: Ref<boolean>, paused: Ref<boolean>, gameOver: Ref<boolean>, won: Ref<boolean>) {
  ...
  return { resumeAudio, playTone, sfxJump, sfxFly, sfxStomp, sfxHit, sfxCheckpoint, sfxPowerUp, sfxWin, startBgMusic, stopBgMusic, closeAudioCtx }
}
